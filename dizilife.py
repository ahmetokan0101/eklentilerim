...
def main():
    """Ana fonksiyon"""
    print(f"\n{BLUE}{'='*60}{RESET}")
    print(f"{BLUE}Dizilife Build ve GitHub Push Script{RESET}")
    ...
    if not run_command(".\\gradlew.bat :Dizilife:make"):
        print_error("Build başarısız!")
        sys.exit(1)
    
    build_file = "Dizilife\\build\\Dizilife.cs3"
    ...
    commit_message = "Update Dizilife.cs3 build"
