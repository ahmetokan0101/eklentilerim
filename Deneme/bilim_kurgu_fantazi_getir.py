...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Bilim Kurgu & Fantazi içeriklerini çekme scripti
"""
...
def bilim_kurgu_fantazi_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Bilim Kurgu & Fantazi kategorisindeki içerikleri çeker
...
def main():
    ...
    result = bilim_kurgu_fantazi_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
