...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Reality-TV içeriklerini çekme scripti
"""
...
def reality_tv_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Reality-TV kategorisindeki içerikleri çeker
...
def main():
    ...
    result = reality_tv_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
