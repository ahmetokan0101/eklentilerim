...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Talk içeriklerini çekme scripti
"""
...
def talk_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Talk kategorisindeki içerikleri çeker
...
def main():
    ...
    result = talk_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
