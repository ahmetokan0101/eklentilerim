...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Fantastik içeriklerini çekme scripti
"""
...
def fantastik_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Fantastik kategorisindeki içerikleri çeker
...
def main():
    ...
    result = fantastik_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
