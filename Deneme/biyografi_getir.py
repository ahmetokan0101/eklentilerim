...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Biyografi içeriklerini çekme scripti
"""
...
def biyografi_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Biyografi kategorisindeki içerikleri çeker
...
def main():
    ...
    result = biyografi_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
