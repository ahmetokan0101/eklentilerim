...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Belgesel içeriklerini çekme scripti
"""
...
def belgesel_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Belgesel kategorisindeki içerikleri çeker
...
def main():
    ...
    result = belgesel_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
