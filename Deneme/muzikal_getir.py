...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Müzikal içeriklerini çekme scripti
"""
...
def muzikal_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Müzikal kategorisindeki içerikleri çeker
...
def main():
    ...
    result = muzikal_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
