...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Thriller içeriklerini çekme scripti
"""
...
def thriller_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Thriller kategorisindeki içerikleri çeker
...
def main():
    ...
    result = thriller_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
