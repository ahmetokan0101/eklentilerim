...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Haberler içeriklerini çekme scripti
"""
...
def haberler_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Haberler kategorisindeki içerikleri çeker
...
def main():
    ...
    result = haberler_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
