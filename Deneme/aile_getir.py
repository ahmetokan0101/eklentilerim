...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Aile içeriklerini çekme scripti
"""
...
def aile_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Aile kategorisindeki içerikleri çeker
...
def main():
    ...
    result = aile_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
