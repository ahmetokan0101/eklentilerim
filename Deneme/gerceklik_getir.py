...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Gerçeklik içeriklerini çekme scripti
"""
...
def gerceklik_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Gerçeklik kategorisindeki içerikleri çeker
...
def main():
    ...
    result = gerceklik_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
