...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Romance içeriklerini çekme scripti
"""
...
def romance_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Romance kategorisindeki içerikleri çeker
...
def main():
    ...
    result = romance_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
