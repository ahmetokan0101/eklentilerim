...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Savaş içeriklerini çekme scripti
"""
...
def savas_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Savaş kategorisindeki içerikleri çeker
...
def main():
    ...
    result = savas_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
