...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Müzik içeriklerini çekme scripti
"""
...
def muzik_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Müzik kategorisindeki içerikleri çeker
...
def main():
    ...
    result = muzik_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
