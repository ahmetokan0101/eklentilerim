...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Spor içeriklerini çekme scripti
"""
...
def spor_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Spor kategorisindeki içerikleri çeker
...
def main():
    ...
    result = spor_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
