...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Suç içeriklerini çekme scripti
"""
...
def suc_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Suç kategorisindeki içerikleri çeker
...
def main():
    ...
    result = suc_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
