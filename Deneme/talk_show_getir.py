...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Talk-Show içeriklerini çekme scripti
"""
...
def talk_show_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Talk-Show kategorisindeki içerikleri çeker
...
def main():
    ...
    result = talk_show_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
