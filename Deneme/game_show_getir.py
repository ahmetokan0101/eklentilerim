...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Game-Show içeriklerini çekme scripti
"""
...
def game_show_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Game-Show kategorisindeki içerikleri çeker
...
def main():
    ...
    result = game_show_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
