...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Korku içeriklerini çekme scripti
"""
...
def korku_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Korku kategorisindeki içerikleri çeker
...
def main():
    ...
    result = korku_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
