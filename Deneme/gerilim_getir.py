...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Gerilim içeriklerini çekme scripti
"""
...
def gerilim_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Gerilim kategorisindeki içerikleri çeker
...
def main():
    ...
    result = gerilim_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
