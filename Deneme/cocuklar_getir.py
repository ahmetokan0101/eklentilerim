...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Çocuklar içeriklerini çekme scripti
"""
...
def cocuklar_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Çocuklar kategorisindeki içerikleri çeker
...
def main():
    ...
    result = cocuklar_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
