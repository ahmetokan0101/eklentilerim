...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Western içeriklerini çekme scripti
"""
...
def western_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Western kategorisindeki içerikleri çeker
...
def main():
    ...
    result = western_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
