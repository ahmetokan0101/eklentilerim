...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Drama içeriklerini çekme scripti
"""
...
def drama_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Drama kategorisindeki içerikleri çeker
...
def main():
    ...
    result = drama_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
