...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Savaş & Politik içeriklerini çekme scripti
"""
...
def savas_politik_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Savaş & Politik kategorisindeki içerikleri çeker
...
def main():
    ...
    result = savas_politik_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
