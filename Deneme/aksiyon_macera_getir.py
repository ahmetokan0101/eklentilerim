...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Aksiyon & Macera içeriklerini çekme scripti
"""
...
def aksiyon_macera_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Aksiyon & Macera kategorisindeki içerikleri çeker
...
def main():
    ...
    result = aksiyon_macera_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
