...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Macera içeriklerini çekme scripti
"""
...
def macera_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Macera kategorisindeki içerikleri çeker
...
def main():
    ...
    result = macera_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
