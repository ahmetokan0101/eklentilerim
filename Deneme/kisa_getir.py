...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Kısa içeriklerini çekme scripti
"""
...
def kisa_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Kısa kategorisindeki içerikleri çeker
...
def main():
    ...
    result = kisa_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
