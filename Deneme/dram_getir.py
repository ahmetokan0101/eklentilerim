...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Dram içeriklerini çekme scripti
"""
...
def dram_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Dram kategorisindeki içerikleri çeker
...
def main():
    ...
    result = dram_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
