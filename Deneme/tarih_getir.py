...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Tarih içeriklerini çekme scripti
"""
...
def tarih_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Tarih kategorisindeki içerikleri çeker
...
def main():
    ...
    result = tarih_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
