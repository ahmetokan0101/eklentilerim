...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Animasyon içeriklerini çekme scripti
"""
...
def animasyon_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Animasyon kategorisindeki içerikleri çeker
...
def main():
    ...
    result = animasyon_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
