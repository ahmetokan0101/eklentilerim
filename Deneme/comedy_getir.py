...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Comedy içeriklerini çekme scripti
"""
...
def comedy_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Comedy kategorisindeki içerikleri çeker
...
def main():
    ...
    result = comedy_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
