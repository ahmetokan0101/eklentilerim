...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Komedi içeriklerini çekme scripti
"""
...
def komedi_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Komedi kategorisindeki içerikleri çeker
...
def main():
    ...
    result = komedi_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
