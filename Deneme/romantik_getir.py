...
# -*- coding: utf-8 -*-
"""
Dizipal'dan Romantik içeriklerini çekme scripti
"""
...
def romantik_getir(sayfa=1, sayfa_basina=30):
    """
    Dizipal'dan Romantik kategorisindeki içerikleri çeker
...
def main():
    ...
    result = romantik_getir(sayfa=sayfa, sayfa_basina=sayfa_basina)
